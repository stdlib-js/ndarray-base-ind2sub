...
```javascript
ind2sub = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ind2sub@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ind2sub@v0.1.1-umd/browser.js"></script>
```
