...
```javascript
ind2sub = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ind2sub@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ind2sub@umd/bundle.js"></script>
```
